              ...
              >
                {cards.map((card, index) => (
                  ...
                  >
                    <a
                      href="#"
                      className="meet_content w-inline-block group"
                      style={{
                        position: 'absolute',
                        top: 0,
                        left: 0,
                    ...
                    >
                      ...
                      <div className="meet_details" style={{ marginTop: 'auto' }}>
                        ...
                        <div className="meet_summary max-h-0 opacity-0 group-hover:max-h-24 group-hover:opacity-100 transition-all duration-500 ease-in-out overflow-hidden">
